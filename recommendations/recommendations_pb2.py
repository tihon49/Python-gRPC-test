...
_RECOMMENDATIONS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='BookDetail',
    full_name='Recommendations.BookDetail',
    index=1,
    containing_service=None,
    input_type=_DATA,
