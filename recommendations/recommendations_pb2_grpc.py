...
class RecommendationsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BookDetail = channel.unary_unary(
                '/Recommendations/BookDetail',
                request_serializer=recommendations__pb2.Data.SerializeToString,
...
def add_RecommendationsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BookDetail': grpc.unary_unary_rpc_method_handler(
                    servicer.BookDetail,
                    request_deserializer=recommendations__pb2.Data.FromString,
...
class Recommendations(object):
    ...
    def BookDetail(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Recommendations/BookDetail',
            recommendations__pb2.Data.SerializeToString,
